...
<?php endif; ?>
        ...
        <div class="row match-height">
            <form id="" method="POST" action="<?php echo e(route('transfer.store')); ?>" enctype="multipart/form-data" class="col-md-12 col-12">
                <?php echo csrf_field(); ?>
                <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form form-horizontal">
                                <div class="form-body">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                            <label><?php echo e(__('transfer.status')); ?></label>
                                        </div>
                                        <div class="col-md-8 form-group">
                                            <select class="form-select" name="status" id="sts">
                                                <option value=""><?php echo e(__('general.choose_status')); ?></option>
                                                <?php $__currentLoopData = $status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s => $values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                            <label><?php echo e(__('transfer.from')); ?></label>
                                        </div>
                                        <div class="col-md-8 form-group">
                                            <select class="form-select" name="from" id="from">
                                                ...
                                                <?php if(Session::get('mystore') == $st->id): ?>
                                                <option value="<?php echo e($st->id); ?>" <?php if($st->id == old('from')): ?> selected <?php endif; ?>><?php echo e($st->name); ?></option>
                                                <?php endif; ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                            <label><?php echo e(__('transfer.to')); ?></label>
                                        </div>
                                        <div class="col-md-8 form-group">
                                            <select class="form-select" name="to" id="to">
                                                <option value=""><?php echo e(__('transfer.choose_store')); ?></option>
                                                <?php $__currentLoopData = $store; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(Session::get('mystore') != $st->id): ?>
                                                <option value="<?php echo e($st->id); ?>" <?php if($st->id == old('from')): ?> selected <?php endif; ?>><?php echo e($st->name); ?></option>
                                                <?php endif; ?>
                        ...
                        <div class="card-body">
                            <div class="form form-horizontal">
                                <div class="form-body">
                                    ...
                                    <h5 class="float-end"><?php echo e(__('purchase.net_total')); ?>: <span id="net_total"></span> </h5>
...
<script>
    $(document).ready(function() {
        $("#selProduct").select2({
            ...
            ajax: {
                url: domainpath + '/pos-admin/stock-transfer/getProduct?store=' + "<?php echo e(Session::get('mystore')); ?>",
                dataType: 'json',
                delay: 250,
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        dataContent +=
                            ...
                            product.stock +
                            '" required><span class="error d-none" style="color: red;">* <?php echo e(__("transfer.qty_have")); ?> ' +
                            product.stock +
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/tymart/resources/views/admin/stock_transfer/create.blade.php ENDPATH**/ ?>