<div class="shadow p-3 homepage-mdhpos-header bg-primary">
    <div class="title d-flex align-items-center">
        <div class="mr-auto">
            <a class="text-dark d-flex align-items-center" href="<?php echo e(route('index')); ?>">
...
</div><?php /**PATH C:\xampp\htdocs\mdhpos\resources\views/components/pos-mobile/header-component.blade.php ENDPATH**/ ?>