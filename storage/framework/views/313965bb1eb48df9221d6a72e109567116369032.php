        ...
        <div class="page-title-box">
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    ...
                    <a class="btn btn-md btn-primary float-end" href="<?php echo e(route('customer.index')); ?>"><i class="fa fa-list"></i> <?php echo e(__('sidebar.customer')); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<?php endif; ?>
                                ...
                                <div class="form-body">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" class="form-control" name="name" value="<?php echo e(old('name')); ?>" id="name" required placeholder="<?php echo e(__('customer.name')); ?> ">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="number" class="form-control" name="phone" value="<?php echo e(old('phone')); ?>" id="phone" required placeholder="<?php echo e(__('general.phone')); ?> ">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-4">
    ...
    <?php $__env->stopSection(); ?>
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mdhpos\resources\views/admin/customer/create.blade.php ENDPATH**/ ?>