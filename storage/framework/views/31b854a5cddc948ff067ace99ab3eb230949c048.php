                ...
                <div class="row">
                    <div class="col-3" style="height:100vh; box-shadow: 1px 1px 1px  #00474d;">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                           <a class="nav-link active" id="cash" data-bs-toggle="pill" href="#cashpay" role="tab" aria-controls="cashpay" aria-selected="true">Cash</a>
                           <a class="nav-link" id="sidik" data-bs-toggle="pill" href="#sidik" role="tab" aria-controls="sidik" aria-selected="false">SiDiK</a>
                           <a class="nav-link" id="bank" data-bs-toggle="pill" href="#banktf" role="tab" aria-controls="banktf" aria-selected="false">Bank Transfer</a>
                           <a class="nav-link" id="card" data-bs-toggle="pill" href="#cc" role="tab" aria-controls="cc" aria-selected="false">Kartu Kredit</a>
                       </div>
                    </div>
                    <div class="col-9">
                            ...
                            <div class="tab-pane fade show active" id="cashpay" role="tabpanel" aria-labelledby="cash">
                                <div class="row m-2 p-2">
                                    <div class="col-6 mb-4">
                                        <button type="button" onclick="payfull()" class="non-sidik btn btn-primary btn-lg btn-rounded btn-block">
                                            <i class="fa fa-wallet"></i> | Bayar Full
                                        </button>
                                    </div>
                                    <div class="col-6 mb-4">
                                        <button type="button" onclick="duefull()" class="non-sidik btn btn-warning btn-lg btn-rounded btn-block">
...
<?php /**PATH /var/www/tymart/resources/views/components/pos/footer-component.blade.php ENDPATH**/ ?>