        ...
        <div class="page-title-box">
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    ...
                    <a class="btn btn-md btn-primary float-end" href="<?php echo e(route('brand.index')); ?>"><i class="fa fa-list"></i> <?php echo e(__('sidebar.brand')); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12 col-12">
                <div class="card ">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form method="POST" enctype="multipart/form-data" class="form form-horizontal" id="cBrandForm">
                                <?php echo csrf_field(); ?>
                                <div class="form-body">
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                            <label><?php echo e(__('settings.brand_name')); ?></label>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="code" class="form-control" name="code" value="<?php echo e(old('code')); ?>" required >
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-12 d-flex justify-content-end">
                                            <button  class="btn btn-info me-1 mb-1"><?php echo e(__('settings.add_brand')); ?></button>
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pos/resources/views/admin/brand/create.blade.php ENDPATH**/ ?>