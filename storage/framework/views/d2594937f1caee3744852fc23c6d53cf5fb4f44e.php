                        ...
                        <div class="card-body">
                            <form method="POST" class="row" id="cEmployee">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="form-group">
                                        <select class="form-select" name="user_id" id="user_id">
                                            ...
                                            <option value="<?php echo e($u->id); ?>" <?php if($u->id == old('user_id')): ?> selected <?php endif; ?>><?php echo e($u->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="form-group">
                                        <input type="date" name="date_birth" value="<?php echo e(old('date_birth')); ?>" id="date_birth" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="salary" value="<?php echo e(old('salary')); ?>" id="salary" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 mb-4">
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control" name="about" id="about"><?php echo e(old('about')); ?></textarea>
                                    </div>
                                </div>
                                <div class="col-12 d-flex justify-content-end">
                                    <button class="btn btn-info"><?php echo e(__('general.add')); ?></button>
                                </div>
                            </form>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mdhpos\resources\views/admin/employee/add_employee.blade.php ENDPATH**/ ?>