                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">: <?php echo e(my_currency($data['total_expense'])); ?> </td>
                        </tr>
                        <tr>
        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
            <div class="table-responsive">
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo e(__('general.total')); ?> </td>
                            <td class="text-right">: <?php echo e(my_currency($gross)); ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="table-responsive">
                ...
                <table class="table">
                    <tbody>
                        <tr style="background-color: #3c8dbc; border: 1px solid white" class="text-white">
                            <th><?php echo e(__('report.profitsell')); ?></th>
                            <th></th>
                        </tr>
                        <tr>
                            <td><?php echo e(__("report.net_profit_before_return")); ?> </td>
                            <td class="text-right">: <?php echo e(my_currency($profitsell->terjual)); ?></td>
                        </tr>
                        <tr>
                            <td><?php echo e(__("report.net_profit_after_return")); ?> </td>
                            <td class="text-right">: <?php echo e(my_currency($profitsell->dikembalikan)); ?></td>
                        </tr>
                        <tr>
                            <td><?php echo e(__('report.return_sell_after_purchase')); ?> </td>
                            <td class="text-right">: <?php echo e(my_currency($profitsell_after_return)); ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
            <div class="table-responsive">
                <table class="table">
                    <tbody>
                        <tr style="background-color: #3c8dbc; border: 1px solid white" class="text-white">
                            <th><?php echo e(__('report.net_profit')); ?></th>
                            <th width="30%"></th>
                            <th></th>
                        </tr>
                        <tr>
                            <td style="font-size:12px"><?php echo e(__('report.profitloss')); ?></td>
                            <td class="text-right">: <?php echo e(my_currency($gross)); ?></td>
                        ...
                        <tr style="background-color: #5cb85c;" class="text-white">
                            <td><?php echo e(__('general.total')); ?> </td>
                            <td class="text-right">: <?php echo e(my_currency($profit)); ?></td>
                            <td class="text-right"></td>
                        </tr>
                    </tbody>
                </table>
...
<?php /**PATH /var/www/pos/resources/views/admin/reports/transaction/profit_page.blade.php ENDPATH**/ ?>