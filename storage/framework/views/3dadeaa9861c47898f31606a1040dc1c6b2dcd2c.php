    ...
    <div class="container-fluid">
        <div class="page-title-box">
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("Tambah Subkategori Pengeluaran")): ?>
                    <a class="btn btn-md btn-primary float-end" href="<?php echo e(route('exsub.create')); ?>"><i class="fa fa-list"></i> <?php echo e(__('category.add_subcategory')); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
                                ...
                                <table class="table table-striped" id="table-1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo e(__('category.subcategory_name')); ?></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="data-product">
                                            ...
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("Update Subkategori Pengeluaran")): ?>
                                                <a href="<?php echo e(route('exsub.update',$c->id)); ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("Hapus Subkategori Pengeluaran")): ?>
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/tymart/resources/views/admin/expense/subcategory.blade.php ENDPATH**/ ?>