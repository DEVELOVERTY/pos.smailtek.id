    ...
    <div class="container-fluid">
        <div class="page-title-box">
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("Tambah Unit")): ?>
                    <a class="btn btn-md btn-primary float-end" href="<?php echo e(route('unit.create')); ?>"><i class="fa fa-plus"></i> <?php echo e(__('settings.add_unit')); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
                                ...
                                <table class="table table-striped" id="table-1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo e(__('settings.unit_name')); ?></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo e(route('unit.update',$d->id)); ?>" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("Hapus Unit")): ?>
                                                <a href="<?php echo e(route('unit.delete',$d->id)); ?>" class="btn btn-danger deletebutton"><i class="fa fa-trash"></i></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\tymart\resources\views/admin/unit/index.blade.php ENDPATH**/ ?>