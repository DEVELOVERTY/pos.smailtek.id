        ...
        <div class="page-title-box">
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    ...
                    <a href="<?php echo e(route('employee.create')); ?>" class="btn btn-md btn-primary float-end"><i class="fa fa-plus"></i> <?php echo e(__('sidebar.add_employee')); ?> </a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
                                ...
                                <table class="table table-striped" id="table-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="data-product">
                                            ...
                                            <td> <?php echo e($c->designation->name ?? ''); ?> </td>
                                            <td> <?php echo e($c->user->store->name ?? __('user.all_store')); ?> </td>
                                            <td> <?php echo e($c->phone ?? ''); ?> </td>
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("Update Pegawai")): ?>
                                                <a href="<?php echo e(route('employee.update',$c->id)); ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("Hapus Pegawai")): ?>
                                                <a href="<?php echo e(route('employee.delete',$c->id)); ?>" class="btn btn-sm btn-danger deletebutton"><i class="fa fa-trash"></i></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/tymart/resources/views/admin/employee/index.blade.php ENDPATH**/ ?>