                                ...
                                <div class="form-body">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" class="form-control" name="kd_category" value="<?php echo e(old('kd_category')); ?>" id="kd_category" required placeholder="Code">
                                        </div>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/tymart/resources/views/admin/category/create.blade.php ENDPATH**/ ?>