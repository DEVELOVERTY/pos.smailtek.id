    ...
    <div class="container-fluid">
        <div class="page-title-box">
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("Tambah Users")): ?>
                    <a class="btn btn-md btn-primary float-end" href="<?php echo e(route('user.create')); ?>"><i class="fa fa-plus"></i> <?php echo e(__('user.add_user')); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
                                ...
                                <table class="table table-striped" id="table-1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo e(__('sidebar.role')); ?></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="<?php echo e(asset($d->photo ?? 'uploads/image.jpg')); ?>" style="width: 50px">
                                            </td>
                                            <td><?php echo e($d->store->name ?? __('user.all_store')); ?></td>
                                            <td>
                                                <a href="<?php echo e(route('user.update',$d->id)); ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                                <?php if($d->id != Auth()->user()->id): ?>
                                                <a href="<?php echo e(route('user.delete',$d->id)); ?>" class="btn btn-sm btn-danger deletebutton"><i class="fas fa-trash"></i></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pos/resources/views/admin/usermanager/users.blade.php ENDPATH**/ ?>