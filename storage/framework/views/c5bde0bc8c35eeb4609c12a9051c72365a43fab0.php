                        ...
                        <div class="card-body">
                            <form method="POST" id="uDesignation" class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="form-group">
                                        <select class="form-select" name="department_id" id="department">
                                            ...
                                            <option value="<?php echo e($d->id); ?>" <?php if($d->id == old('department_id',$designation->department_id)): ?> selected <?php endif; ?>><?php echo e($d->name); ?></option>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" name="id" value="<?php echo e($designation->id); ?>" id="designation_id">
                                        <input type="text" name="name" value="<?php echo e(old('name',$designation->name)); ?>" id="name" class="form-control">
                                    </div>
                                </div>
                                <div class="col-12 d-flex justify-content-end">
                                    <button class="btn btn-primary me-1 mb-1"><?php echo e(__('general.save')); ?></button>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pos/resources/views/admin/hrm/update_designation.blade.php ENDPATH**/ ?>