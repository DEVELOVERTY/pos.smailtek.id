    ...
    <div class="container-fluid">
        <div class="page-title-box">
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("Tambah Tunjangan")): ?>
                    <a href="<?php echo e(route('allowance.create')); ?>" class="btn btn-md btn-primary float-end"><i class="fa fa-plus"></i> <?php echo e(__('hrm.add_allowance')); ?> </a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
                                ...
                                <table class="table table-striped" id="table-1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo e(__('hrm.amount_allowance')); ?></th>
                                            <th><?php echo e(__('hrm.allowance_option')); ?></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("Update Tunjangan")): ?>
                                                <a href="<?php echo e(route('allowance.update',$d->id)); ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("Hapus Tunjangan")): ?>
                                                <a href="<?php echo e(route('allowance.delete',$d->id)); ?>" class="btn btn-sm btn-danger deletebutton"><i class="fas fa-trash"></i></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/tymart/resources/views/admin/allowance/index.blade.php ENDPATH**/ ?>