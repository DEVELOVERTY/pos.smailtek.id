...
<?php else: ?>
    <div class="authbg" style="background: url('data:image/png;base64,<?php echo e($data->bg_login); ?>');background-size: cover;background-position: center;"></div>
<?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pos.backup/resources/views/auth/login.blade.php ENDPATH**/ ?>