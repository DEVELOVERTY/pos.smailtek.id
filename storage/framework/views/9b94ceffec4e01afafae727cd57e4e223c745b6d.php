        ...
        <div class="page-title-box">
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    ...
                    <a class="btn btn-md btn-primary float-end" href="<?php echo e(route('supplier.create')); ?>"><i class="fa fa-plus"></i> <?php echo e(__('sidebar.add_supplier')); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div> 
                        ...
                        <div class="card-body"> 
                            <div class="table-responsive">
                                <table class="table table-striped" id="table-1">
                                    <thead>
                                        <tr>
                                            <th class="text-center"> <?php echo e(__('general.no')); ?> </th>
                                            <th><?php echo e(__('supplier.name')); ?></th>
                                            <th><?php echo e(__('supplier.phone')); ?></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo e(route('supplier.update', $d->id)); ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("Hapus Supplier")): ?>
                                                <a href="<?php echo e(route('supplier.delete', $d->id)); ?>" class="btn btn-sm btn-danger deletebutton"><i class="fa fa-trash"></i></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mdhpos\resources\views/admin/supplier/index.blade.php ENDPATH**/ ?>