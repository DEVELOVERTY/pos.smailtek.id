            ...
            <div class="col-12">
                <div class="card ">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form method="POST" class="row" id="cStore">
                                <?php echo csrf_field(); ?>
                                <div class="col-md-4 mb-4">
                                    <h6><?php echo e(__('store.choose_country')); ?></h6>
                                    <div class="form-group">
                                        <select class="choices form-select" name="country_id" id="country">
                                            ...
                                            <option value="<?php echo e($d->id); ?>" <?php if($d->id == old('country_id')): ?> selected <?php endif; ?>><?php echo e($d->name); ?></option>
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div class="form-group">
                                        <select class="choices form-select" name="currency_id" id="currency">
                                            ...
                                            <option value="<?php echo e($c->id); ?>" <?php if($c->id == old('currency_id')): ?> selected <?php endif; ?>><?php echo e($c->country); ?> - <?php echo e($c->code); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div class="form-group">
                                        <select class="choices form-select" name="printer_id" id="printer">
                                            ...
                                            <option value="<?php echo e($p->id); ?>" <?php if($p->id == old('printer_id')): ?> selected <?php endif; ?>><?php echo e($p->name); ?> - <?php echo e($p->type); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="code" value="<?php echo e(old('code')); ?>" id="code" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="form-group">
                                        <input type="number" name="phone" value="<?php echo e(old('phone')); ?>" id="phone" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="zip_code" value="<?php echo e(old('zip_code')); ?>" id="zip_code" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <h6><?php echo e(__('purchase.tax')); ?></h6>
                                    <div class="form-group">
                                        <input type="number" name="tax" value="<?php echo e(old('tax','0')); ?>" id="tax" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    <h6>Zakat</h6>
                                    <div class="form-group">
                                        <input type="number" name="zakat" value="<?php echo e(old('zakat','0')); ?>" id="zakat" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    <h6><?php echo e(__('sound_in_pos')); ?></h6>
                                    <div class="form-group">
                                ...
                                <div class="col-md-12 mb-4">
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control" name="footer_text" id="footer_text"><?php echo e(old('footer_text')); ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" name="reference_format" id="reference_format">
                                            ...
                                            <option value="<?php echo e($key); ?>" <?php if($key==old('reference_format')): ?> selected <?php endif; ?>><?php echo e($value); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mb-4">
                                    <h6>GST Reg. No</h6>
                                    <div class="form-group">
                                        <input type="text" name="gst" value="<?php echo e(old('gst')); ?>" id="gst" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mb-4">
                                    <h6>VAT Reg. No</h6>
                                    <div class="form-group">
                                        <input type="text" name="vat" value="<?php echo e(old('vat')); ?>" id="vat" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-6">
                                    <h6>LongTitude</h6>
                                    <div class="form-group">
                                        <input type="text" name="long" value="<?php echo e(old('long')); ?>" id="long" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-6">
                                    <h6>Langtitude</h6>
                                    <div class="form-group">
                                        <input type="text" name="lang" value="<?php echo e(old('lang')); ?>" id="lang" class="form-control">
                                    </div>
                                </div>

                                <div class="col-12 d-flex justify-content-end mt-4">
                                    <button class="btn btn-primary"><?php echo e(__('general.save')); ?></button>
                                </div>
                            </form>
                        </div>
                    </div>
...
<script src="<?php echo e(asset('assets/vendors/maps/store_create.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pos/resources/views/admin/store/create.blade.php ENDPATH**/ ?>