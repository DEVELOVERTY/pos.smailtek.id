        ...
        <div class="page-title-box">
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    ...
                    <a class="btn btn-md btn-primary float-end" href="<?php echo e(route('exca.index')); ?>"><i class="fa fa-list"></i> <?php echo e(__('sidebar.expense_category')); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pos/resources/views/admin/expense/create.blade.php ENDPATH**/ ?>