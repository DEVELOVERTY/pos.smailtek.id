                                ...
                                <div class="form-body">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" class="form-control" name="name" placeholder="<?php echo e(__('settings.printer_name')); ?> ">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" name="ip_address" class="form-control" placeholder="<?php echo e(__('settings.ip_address')); ?>">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-12 d-flex justify-content-end">
                                            <button class="btn btn-primary me-1 mb-1"><?php echo e(__('settings.add_printer')); ?></button>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/tymart/resources/views/admin/settings/create_printer.blade.php ENDPATH**/ ?>