                        ...
                        <div class="card-body" id="printarea">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <h4><?php echo e(__('report.product_info')); ?>:</h4>
                                </div>
                                <div class="col-sm-12 col-xs-12">
                            ...
                            <div class="row text-center mt-5 mb-3">
                                <div class="col-12">
                                    <a target="_blank" href="<?php echo e(route('due.print',$data->id)); ?>" class="btn btn-primary"><i class="fas fa-print"></i> <?php echo e(__('general.print')); ?></a>
                                </div>
                            </div>
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pos/resources/views/admin/reports/transaction/due_detail.blade.php ENDPATH**/ ?>