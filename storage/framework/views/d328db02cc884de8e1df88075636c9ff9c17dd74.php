        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('sett.bg_login_store')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
                                <label for="bg_login"><?php echo e(__('Choose Image')); ?></label>
                        ...
                        <?php if($settings->bg_login): ?>
                            <div class="mt-3">
                                <img src="data:image/jpeg;base64,<?php echo e($settings->bg_login); ?>" alt="Background Login" class="img-fluid">
                            </div>
                        <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/tymart/resources/views/admin/settings/index.blade.php ENDPATH**/ ?>