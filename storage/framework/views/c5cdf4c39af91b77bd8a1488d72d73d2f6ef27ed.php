    ...
    <div class="container-fluid">
        <div class="page-title-box">
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("Tambah Brand")): ?>
                    <a class="btn btn-md btn-primary float-end" href="<?php echo e(route('brand.create')); ?>"><i class="fa fa-plus"></i> <?php echo e(__('settings.add_brand')); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
                                ...
                                <table class="table table-striped" id="table-1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo e(__('settings.brand_name')); ?></th>
                                            <th><?php echo e(__('general.code')); ?></th>
                                            <th><?php echo e(__('general.detail')); ?></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"> <?php echo e($d->id); ?> </td>
                                            <td> <?php echo e($d->name); ?> </td>
                                            <td> <?php echo e($d->code); ?> </td>
                                            <td> <?php echo e($d->detail); ?> </td>
                                            <td> <img src="<?php echo e(asset($d->image)); ?>" width="60px"> </td>
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("Update Brand")): ?>
                                                <a href="<?php echo e(route('brand.update',$d->id)); ?>" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("Hapus Brand")): ?>
                                                <a href="<?php echo e(route('brand.delete',$d->id)); ?>" class="btn btn-danger deletebutton"><i class="fa fa-trash"></i></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\tymart\resources\views/admin/brand/index.blade.php ENDPATH**/ ?>