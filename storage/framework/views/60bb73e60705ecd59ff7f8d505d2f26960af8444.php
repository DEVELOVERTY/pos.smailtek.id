        ...
        <div class="page-title-box">
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    ...
                    <a class="btn btn-md btn-primary float-end" href="<?php echo e(route('product.create')); ?>">
                        <i class="fa fa-plus"></i> <?php echo e(__('sidebar.add_product')); ?>

                    </a>
                    <a class="btn btn-md btn-success float-end me-2" href="<?php echo e(route('product.export')); ?>">
...
<?php endif; ?> 
    ...
    <?php $__env->stopSection(); ?>
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/tymart/resources/views/admin/product/index.blade.php ENDPATH**/ ?>