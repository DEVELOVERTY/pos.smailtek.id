...
<?php endif; ?>
                    ...
                    <div class="card-header header-modal">
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <a href="<?php echo e(route('return.download')); ?>" class="btn btn-sm btn-success float-end" style="margin-top: -5px; border: 2px solid white"><i class="fas fa-download"></i> <?php echo e(__("report.download_excel")); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo e(__('report.return_product')); ?></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <?php echo e(count($d->returndetail)); ?> </td>
                                            <td> <?php echo e($d->qty_return); ?> </td>
                                    ...
                                    <tfoot>
                                        <tr style="background-color: #5cb85c; border: 1px solid white" class="text-white">
                                            <th colspan="7" style="height: 100px; font-size:30px"><?php echo e(__('general.total')); ?></th>
    ...
    <script>
        ...
        function searchProduct() {
            ...
            var url = domainpath + '/pos-admin/report/transaction/return?store=' + store + '&start_date=' + start + '&end_date=' + end + '';
            spinner.show();
            setTimeout(function() {
                $.ajax({
                    url: url,
    ...
    <?php $__env->stopSection(); ?>
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\tymart\resources\views/admin/reports/transaction/return.blade.php ENDPATH**/ ?>