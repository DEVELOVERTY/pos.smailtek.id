    ...
    <div class="container-fluid">
        ...
        <div class="page-title-box">
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <?php if(Auth()->user()->can("Tambah Subkategori")): ?>
                    <a class="btn btn-md btn-primary float-end" href="<?php echo e(route('subcategory.create')); ?>"><i class="fa fa-plus"></i> <?php echo e(__('category.add_subcategory')); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
                                ...
                                <table class="table table-striped" id="table-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="data-product">
                                            ...
                                            <td>
                                                <?php if(Auth()->user()->can("Update Subkategori")): ?>
                                                <a href="<?php echo e(route('subcategory.update',$c->id)); ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                                <?php endif; ?>
                                                <?php if(Auth()->user()->can("Hapus Subkategori")): ?>
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mdhpos\resources\views/admin/category/subcategory.blade.php ENDPATH**/ ?>