...
class UserController extends Controller
{
    public function verifyFingerprint($userId, $transactionCode)
    {
        ...
        $res = Http::withHeaders([
            ...
            ->json();
        echo $userId . "," . $transactionCode .';' . $res['data'] . ";SecurityKey;" . $time_limit_ver . ";" . "https://pos.smailtek.id/api/user/verify-fingerprint" . ";" . "https://admin.sidikty.com/api/device-ac-sn-by-vc;extraParams";
