                        ...
                        <div class="card-body">
                            <form method="POST" class="row" id="cStore">
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div class="form-group">
                                        <select class="choices form-select" name="country_id" id="country">
                                            ...
                                            <option value="{{$d->id}}" @if($d->id == old('country_id')) selected @endif>{{$d->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div class="form-group">
                                        <select class="choices form-select" name="currency_id" id="currency">
                                            ...
                                            <option value="{{$c->id}}" @if($c->id == old('currency_id')) selected @endif>{{$c->country}} - {{ $c->code }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div class="form-group">
                                        <select class="choices form-select" name="printer_id" id="printer">
                                            ...
                                            <option value="{{$p->id}}" @if($p->id == old('printer_id')) selected @endif>{{$p->name}} - {{ $p->type }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="zip_code" value="{{old('zip_code')}}" id="zip_code" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <h6>{{__('purchase.tax')}}</h6>
                                    <div class="form-group">
                                        <input type="number" name="tax" value="{{old('tax','0')}}" id="tax" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    <h6>Zakat</h6>
                                    <div class="form-group">
                                        <input type="number" name="zakat" value="{{old('zakat','0')}}" id="zakat" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 mb-4">
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control" name="footer_text" id="footer_text">{{ old('footer_text') }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" name="reference_format" id="reference_format">
                                            ...
                                            <option value="{{$key}}" @if($key==old('reference_format')) selected @endif>{{$value}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mb-4">
                                    <h6>GST Reg. No</h6>
                                    <div class="form-group">
                                        <input type="text" name="gst" value="{{old('gst')}}" id="gst" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mb-4">
                                    <h6>VAT Reg. No</h6>
                                    <div class="form-group">
                                        <input type="text" name="vat" value="{{old('vat')}}" id="vat" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-6">
                                    <h6>LongTitude</h6>
                                    <div class="form-group">
                                        <input type="text" name="long" value="{{old('long')}}" id="long" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-6">
                                    <h6>Langtitude</h6>
                                    <div class="form-group">
                                        <input type="text" name="lang" value="{{old('lang')}}" id="lang" class="form-control">
                                    </div>
                                </div>
