            ...
            <div class="col-md-12 col-12">
                <div class="card ">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form id="cCutting" method="POST" class="form form-horizontal">
                                @csrf
                                <div class="form-body">
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" class="form-control" name="amount" value="{{ old('amount') }}" id="amount" required placeholder="Jumlah Potongan">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
