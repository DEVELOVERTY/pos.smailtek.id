...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row match-height">
            <form id="" method="POST" action="{{ route('adjustment.store') }}" enctype="multipart/form-data" class="col-md-12 col-12">
                @csrf
                <div class="card">
                                    ...
                                    <div class="row"> 
                                        ...
                                        <div class="col-md-8 form-group">
                                            <select class="form-select" name="type" id="type">
                                                <option value="">{{__('adjustment.choose_type')}}</option>
                                                @foreach ($type as $t => $values)
                                                <option value="{{ $t }}" @if ($t==old('type')) selected @endif>{{ $values }}</option>
                                                @endforeach
                                            </select>
                                        </div> 
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="form form-horizontal">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label>{{__('adjustment.amount_recovered')}}</label>
                                        </div>
                                        <div class="col-md-8 form-group">
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control" value="{{ old('total_amount_recovered', 0) }}" id="total_amount_recovered" name="total_amount_recovered">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
