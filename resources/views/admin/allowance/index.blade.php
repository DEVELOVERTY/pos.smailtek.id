                                ...
                                <table class="table table-striped" id="table-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @can("Update Tunjangan")
                                                <a href="{{route('allowance.update',$d->id)}}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                                @endcan
                                                @can("Hapus Tunjangan")
                                                <a href="{{route('allowance.delete',$d->id)}}" class="btn btn-sm btn-danger deletebutton"><i class="fas fa-trash"></i></a>
                                                @endcan
                                            </td>
                                        </tr>
                                        @endforeach
