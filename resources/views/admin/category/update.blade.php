                                ...
                                <div class="form-body">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" class="form-control" name="kd_category" value="{{ old('kd_category',$category->kd_category) }}" id="kd_category" required placeholder="Code">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" class="form-control" name="name" value="{{ old('name',$category->name) }}" id="name" required placeholder="{{__('category.category_name')}} ">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-4">
