    ...
    <div class="container-fluid">
        ...
        <div class="page-title-box">
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    @if(Auth()->user()->can("Tambah Subkategori"))
                    <a class="btn btn-md btn-primary float-end" href="{{ route('subcategory.create') }}"><i class="fa fa-plus"></i> {{__('category.add_subcategory')}}</a>
                    @endcan
                </div>
            </div>
        </div>
                                ...
                                <table class="table table-striped" id="table-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="data-product">
                                            ...
                                            <td>
                                                @if(Auth()->user()->can("Update Subkategori"))
                                                <a href="{{ route('subcategory.update',$c->id) }}" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                                @endif
                                                @if(Auth()->user()->can("Hapus Subkategori"))
