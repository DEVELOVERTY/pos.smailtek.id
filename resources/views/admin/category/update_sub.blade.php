        ...
        <div class="page-title-box">
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    ...
                    <a class="btn btn-md btn-primary float-end" href="{{ route('subcategory.index') }}"><i class="fa fa-list"></i> {{ __('sidebar.subcategory') }}</a>
                    @endcan
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12 col-12">
                <div class="card ">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form id="uSubcategory" method="POST" enctype="multipart/form-data" class="form form-horizontal">
                                @csrf
                                <div class="form-body">
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" class="form-control" name="name" value="{{ old('name',$category->name) }}" id="name" required placeholder="{{__('category.subcategory_name')}} ">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-4">
