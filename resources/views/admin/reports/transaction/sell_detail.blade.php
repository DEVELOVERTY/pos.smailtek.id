                    ...
                    <div class="card-content">
                        <div class="card-body" id="printarea">
                            ...
                            <div class="row text-center mt-5 mb-3">
                                <div class="col-12">
                                    @can("Print Penjualan")
                                    <a target="_blank" href="{{ route('sell.print',$data->id) }}" class="btn btn-primary"><i class="fas fa-print"></i> {{__('general.print')}}</a>
                                    @endcan
                                    <a href="javascript:void(0)" id="{{ $data->id }}" onclick="printcepeipt(this.id)" class="btn btn-primary"><i class="fas fa-print"></i> {{__('pos.print')}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
