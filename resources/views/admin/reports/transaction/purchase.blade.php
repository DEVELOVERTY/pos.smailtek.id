                    ...
                    <div class="card-header header-modal">
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <a href="{{route('purchase.download')}}" class="btn btn-sm btn-success float-end" style="margin-top: -5px; border: 2px solid white"><i class="fas fa-download"></i> {{__('report.download_excel')}}</a>
                                @endcan
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tfoot>
                                        <tr style="background-color: #5cb85c; border: 1px solid white" class="text-white">
                                            <th colspan="9" style="height: 100px; font-size:30px">{{__('general.total')}} : </th>
