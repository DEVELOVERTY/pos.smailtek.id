                    ...
                    <div class="card-header header-modal">
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <a href="{{route('return.download')}}" class="btn btn-sm btn-success float-end" style="margin-top: -5px; border: 2px solid white"><i class="fas fa-download"></i> {{__("report.download_excel")}}</a>
                                @endcan
                            </div>
                        </div>
                    </div>
